...
const openai = new OpenAI({
  apiKey: "sk-proj-01234567890123456789012345678901",
});
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        await page.waitForSelector(credentials.submitSelector, {
          timeout: 10000,
        });
      ...
      if (body.record) {
        ...
        if (recordingPath) {
          ...
          recordingUrl = await uploadToDrive(
            blob as any,
